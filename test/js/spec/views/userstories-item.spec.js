describe("App.Views.UserStoriesItem", function () {
    ...
    before(function () {
        ...
        this.view = new App.Views.UserStoriesItem({
            model: new App.Models.UserStory({ id: "0", title: "title" })
        }, {
    ...
    describe("DOM", function () {
        it("renders data to HTML", function () {
            ...
            expect($item.find(".userstory-title").text()).to.equal("title");
        });
    });

    describe("actions", function () {
        it("views on click", function () {
            this.view.$(".userstory-view").click();

            expect(this.navigate)
                .to.be.calledOnce.and
                .to.be.calledWith("userstory/0/view");
        });

        it("edits on click", function () {
            this.view.$(".userstory-edit").click();

            expect(this.navigate)
                .to.be.calledOnce.and
                .to.be.calledWith("userstory/0/edit");
        });
        ...
        it("deletes on click", sinon.test(function () {
            ...
            this.view.$(".userstory-delete").click();
